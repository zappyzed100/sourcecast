...
候補一覧・審査（Phase 11タスク1）は実DB（store/candidates.py・
store/candidate_decisions.py）へ接続済み。ダッシュボード・ジョブ一覧は引き続き
fixture（実ジョブ接続はPhase 11タスク2）。
"""
...
from history_radio.domain.models import Candidate, CandidateDecision, Job
